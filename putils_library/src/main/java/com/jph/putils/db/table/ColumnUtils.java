...
import com.jph.putils.db.annotation.*;
import com.jph.putils.db.annotation.Column;
import com.jph.putils.db.annotation.Finder;
import com.jph.putils.db.annotation.Foreign;
...
public class ColumnUtils {
    ...
    public static Class<?> getForeignEntityType(com.jph.putils.db.table.Foreign foreignColumn) {
    ...
    @SuppressWarnings("unchecked")
    public static Class<?> getFinderTargetEntityType(com.jph.putils.db.table.Finder finderColumn) {
